...
public class ConnectFourGameImpl implements ConnectFourGame {
     ...
     */
    public ConnectFourGameImpl(GameGrid gameGrid, GameMode gameMode, Player player1, Player player2){
